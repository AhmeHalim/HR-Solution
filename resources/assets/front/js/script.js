    ...
    if ($('.price-range-slider').length) {
        ...
        priceSlider.slider({
            ...
            slide: function (event, ui) {
                $("input.property-amount").val("From: " + ui.values[0] + "LE - To: " + ui.values[1] + "LE");
            }
        });

        $("input.property-amount").val("From: " + priceSlider.slider("values", 0) + "LE - To: " + priceSlider.slider("values", 1) + "LE");
    }
});
