            ...
            <div class="row">
                <div class="col-sm-12 col-xl-12 col-lg-12">
                    <div class="card custom-card overflow-hidden">
                        ...
                        <div class="card-body">
                            <div>
                                <h6 class="card-title mb-1">{{trans('home.departement_managers')}}   </h6> <span class="badge badge-warning">{{trans('home.please make sure the total kpis value 100%')}}</span>
                                <hr>
                            </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-xl-12 col-lg-12">
                    <div class="card custom-card overflow-hidden">
                        ...
                        <div class="card-body">
                            <div>
                                <h6 class="card-title mb-1">{{trans('home.departement_employees')}}   </h6> <span class="badge badge-warning">{{trans('home.please make sure the total kpis value 100%')}}</span>
                                <hr>
                            </div>
