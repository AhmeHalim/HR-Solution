...
<head>
    ...
    @yield('meta')
    <!-- Favicon -->
    <link rel="icon" href="{{Helper::uploadedImagesPath('configrations',$configration->fav_icon)}}" type="image/x-icon" />
    ...
    <!---Ion.rangeslider css-->
    <link href="{{URL::To('resources/assets/back/plugins/ion-rangeslider/css/ion.rangeSlider.css')}}" rel="stylesheet">
    <link href="{{URL::To('resources/assets/back/plugins/ion-rangeslider/css/ion.rangeSlider.skinFlat.css')}}" rel="stylesheet">
...
<body @if(auth()->user()->theme == 'dark') class="dark-theme" @endif>
        ...
        <div class="main-sidebar main-sidebar-sticky side-menu">
            <div class="sidemenu-logo">
                <a class="main-logo" href="{{LaravelLocalization::localizeUrl('admin')}}">
                    <img src="{{Helper::uploadedImagesPath('configrations',$configration->app_logo)}}" alt="logo" width="70px" height="70px">
                </a>
            </div>
            ...
            <div class="main-sidebar-body">
                <ul class="nav">
                    ...
                    @can('testimonial')
                        <li class="nav-item @if(Request::segment(3) == 'testimonials') active show @endif">
                            <a class="nav-link" href="{{LaravelLocalization::localizeUrl('admin/testimonials')}}"><i class="fas fa-user-tie"></i><span class="sidemenu-label">{{trans('home.testimonials')}}</span></a>
                        </li>
                    @endcan
    ...
    <!-- Ion-rangeslider js-->
    <script src="{{URL::To('resources/assets/back/plugins/ion-rangeslider/js/ion.rangeSlider.min.js')}}"></script>
