@extends('layouts.app')
@section('meta')
    <title>{{trans('home.recommended_projects')}}</title>
@endsection
...
<section class="page-title centred jarallax" data-jarallax data-speed="0.2" data-imgPosition="0% 0%" style="background-image: url({{Helper::imageFilesPath('banner/banner-4.webp')}});">
    <div class="container">
        <div class="content-box clearfix">
            <h1>{{trans('home.recommended_projects')}}</h1>
            <ul class="bread-crumb clearfix">
                <li><a href="{{LaravelLocalization::localizeUrl('/')}}">{{trans('home.home')}}</a></li>
                <li>{{trans('home.recommended_projects')}}</li>
            </ul>
        </div>
    </div>
</section>
                    ...
                    <div class="property-content-side">
                        <div class="item-shorting clearfix">
                            <div class="left-column pull-left">
                                <h5>{{trans('home.Search Reasults')}} : <span>{{trans('home.Showing')}} {{ $recommendedProjects->count() }} of {{ $recommendedProjects->total() }} </span></h5>
                            </div>
                        ...
                        <div class="wrapper grid">
                            <div class="deals-list-content list-item">
                                @foreach($recommendedProjects as $key=>$project)
