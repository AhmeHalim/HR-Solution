...
<section class="page-title centred jarallax" data-jarallax data-speed="0.2" data-imgPosition="0% 0%" style="background-image: url({{Helper::imageFilesPath('banner/banner-4.webp')}});">
    <div class="container">
        <div class="content-box clearfix">
            <h1>{{(app()->getLocale() == 'en')?$category->name_en:$category->name_ar}} {{trans('projects')}}</h1>
            <ul class="bread-crumb clearfix">
                <li><a href="{{LaravelLocalization::localizeUrl('/')}}">{{trans('home.home')}}</a></li>
                <li>{{(app()->getLocale() == 'en')?$category->name_en:$category->name_ar}} {{trans('projects')}}</li>
            </ul>
        </div>
    </div>
</section>
                                            ...
                                            <div class="feature-block-one">
                                                <div class="inner-box">
                                                    ...
                                                    <div class="lower-content">
                                                        ...
                                                        <div class="btn-box"><a href="{{(app()->getLocale() == 'en')? LaravelLocalization::localizeUrl('project/'.$project->link_en) : LaravelLocalization::localizeUrl('project/'.$project->link_ar)}}" class="theme-btn btn-two">{{trans('home.more_details')}}</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
