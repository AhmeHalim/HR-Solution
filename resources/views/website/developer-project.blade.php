...
<section class="page-title centred jarallax" data-jarallax data-speed="0.2" data-imgPosition="0% 0%" style="background-image: url({{Helper::imageFilesPath('banner/banner-4.webp')}});">
    <div class="container">
        <div class="content-box clearfix">
            <h1>{{(app()->getLocale() == 'en')?$developer->name_en:$developer->name_ar}} {{trans('home.projects')}}</h1>
            <ul class="bread-crumb clearfix">
                <li><a href="{{LaravelLocalization::localizeUrl('/')}}">{{trans('home.home')}}</a></li>
                <li>{{(app()->getLocale() == 'en')?$developer->name_en:$developer->name_ar}} {{trans('projects')}}</li>
            </ul>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 content-side">
                                            ...
                                            <div class="feature-block-one">
                                                <div class="inner-box">
                                                    ...
                                                    <div class="lower-content">
                                                        ...
                                                        <div class="btn-box"><a href="{{(app()->getLocale() == 'en')? LaravelLocalization::localizeUrl('project/'.$project->link_en) : LaravelLocalization::localizeUrl('project/'.$project->link_ar)}}" class="theme-btn btn-two">{{trans('home.read_more')}}</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                @else
                    <div class="text-center">
                        ...
                        <h4 >{{trans('home.no_data_found_with_this_page')}}</h4 >
                    </div>
                @endif
            </div>
        </div>
